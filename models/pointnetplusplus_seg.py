...
class get_model(nn.Module):
    def __init__(self):
        ...
        #set up STN block 
        #It removes spatial invariance from images by applying a learnable affine transformation followed by interpolation.
        self.stn = STN3d(nb_channel)


        self.conv1 = torch.nn.Conv1d(nb_channel, 64, 1)
        ...
        self.convs4 = torch.nn.Conv1d(128, part_class, 1)
